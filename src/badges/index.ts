...
const Badges: Badge[] = [
  ...
  },
  {
    ...
    poolSize: 500000,
    maxSupply: 100,
    externalLink: "https://baes.so/#token",
  },
  {
    name: "Clank, Clank",
    nftId: "38",
    ...
    description: "Clank a Token on Base",
    fullDescription:
  ...
  // },
  {
    name: "Based Connector",
    nftId: "40",
    image: `${LINK_PREFIX}/40.png`,
    rewardImage: `${LINK_PREFIX}/40.png`,
    description: "Refer 1 Qualified Friend",
    fullDescription:
      "Successfully refer 1 friend to Hydrex Protocol Mining who earns you 1000+ Hydropoints.",
    type: "Activity",
    category: "Social",
    partnerName: "Hydrex",
    minHydropoints: 1000,
  ...
  },
  {
    name: "Fren Magnet",
    nftId: "41",
    image: `${LINK_PREFIX}/41.png`,
    rewardImage: `${LINK_PREFIX}/41.png`,
    description: "Refer 5 Qualified Degens",
    fullDescription:
      "Successfully refer 5 friends to Hydrex Protocol Mining who each earn you 1000+ Hydropoints.",
    type: "Activity",
    category: "Social",
    partnerName: "Hydrex",
    minHydropoints: 5000,
  ...
  },
  {
    ...
    nftId: "42",
    image: `${LINK_PREFIX}/42.png`,
    rewardImage: `${LINK_PREFIX}/42.png`,
    description: "Double Digit Hydrex Referrer",
    fullDescription:
      "Successfully refer 10 friends to Hydrex Protocol Mining who each earn you 1000+ Hydropoints.",
    type: "Activity",
    category: "Social",
    partnerName: "Hydrex",
    minHydropoints: 10000,
  ...
  },
  {
    name: "Hydrex KOL",
    nftId: "43",
    image: `${LINK_PREFIX}/43.png`,
    rewardImage: `${LINK_PREFIX}/43.png`,
    description: "Legendary Referrer Status",
    fullDescription:
      "Successfully refer 25 friends to Hydrex Protocol Mining who each earn you 1000+ Hydropoints.",
    type: "Activity",
    category: "Social",
    partnerName: "Hydrex",
